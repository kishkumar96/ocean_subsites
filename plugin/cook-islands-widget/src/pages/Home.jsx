...
const WAVE_BUOYS = [
  // Cook Islands wave buoys - these would need to be updated with actual Cook Islands buoy data
  {
    id: "COOK-BUOY-1",
    lon: -159.7762,
    lat: -21.2311,
...
// Cook Islands bounds - covers both Northern and Southern Cook Islands
const southWest = L.latLng(-22.0, -166.0);
const northEast = L.latLng(-8.0, -157.0);
...
function CookIslandsForecast() {
  ...
  }, [isDragging, dragOffset.x, dragOffset.y, setSidebarPosition]);
